...
public class AdapterFinder{
    ...
    String [] searchSeqsStr = {"AATGTACTTCGTTCAGTTACGTATTGCT","AGCAATACGTAACTGAACGAAGTACATT"};
    public AdapterFinder(String fileName, int threads, int maxEditDistance, int searchSeqLength) throws IOException {
        ...
        this.output = new BufferedWriter(new FileWriter(fileName + ".adapter.found.txt"));

        this.negOutput = new BufferedWriter(new FileWriter(fileName + ".adapter.notFound.txt"));
    ...
    public static void main(String [] args) throws InterruptedException, ExecutionException, IOException{
        ...
        AdapterFinder seqFinder=new AdapterFinder(inFile, threads, minEditDist);
